...
This project uses the openSUSE Java 17 image [here](https://github.com/CAFapi/opensuse-java17-images) to build a pre-configured OpenSearch 2 Docker image.
...
`docker run -d --name os2 -p 9200:9200 -p 9300:9300 -e "discovery.type=single-node" cafapi/opensuse-opensearch2`
